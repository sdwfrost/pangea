...
```{r}
regional.replicate.files <- list.files("../sequences",pattern="28.*fas$",full.names=TRUE)
regional.replicate.files <- regional.replicate.files[!grepl("_rep1_",regional.replicate.files)]
for(i in 1:length(regional.replicate.files)){
  print(i)
  seqfn <- regional.replicate.files[i]
